...
def register_auth_identity_tools(mcp: FastMCP) -> None:
    ...
    mcp.tool(name="rancher_users_list")(rancher_users_list_tool)
    mcp.tool(name="rancher_user_get")(rancher_user_get_tool)
    mcp.tool(name="rancher_groups_list")(rancher_groups_list_tool)
    mcp.tool(name="rancher_group_get")(rancher_group_get_tool)
    mcp.tool(name="rancher_auth_configs_list")(rancher_auth_configs_list_tool)
    mcp.tool(name="rancher_auth_config_get")(rancher_auth_config_get_tool)
