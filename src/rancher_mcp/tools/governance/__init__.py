...
from rancher_mcp.tools.governance._generated_resource_quotas import (
    ...
    rancher_resource_quota_delete_tool,
...
def register_governance_tools(mcp: FastMCP) -> None:
    ...
    mcp.tool(name="rancher_limit_range_delete", annotations=DESTRUCTIVE)(
        rancher_limit_range_delete_tool
    )
    mcp.tool(name="rancher_limit_range_set_labels", annotations=IDEMPOTENT_WRITE)(
        rancher_limit_range_set_labels_tool
    )
    mcp.tool(name="rancher_limit_range_set_annotations", annotations=IDEMPOTENT_WRITE)(
        rancher_limit_range_set_annotations_tool
    )
    ...
    mcp.tool(name="rancher_resource_quota_delete", annotations=DESTRUCTIVE)(
        rancher_resource_quota_delete_tool
    )
