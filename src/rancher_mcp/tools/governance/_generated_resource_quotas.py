...
async def rancher_resource_quotas_list(
    ...
    """List resource_quotas with typed summaries — in one namespace, or cluster-wide when namespace is omitted."""
...
async def _patch_resource_quota_set_labels(
    ...
    """Set_labels one resource_quota via JSON merge-patch; returns a mutation receipt."""
...
async def _patch_resource_quota_set_annotations(
    ...
    """Set_annotations one resource_quota via JSON merge-patch; returns a mutation receipt."""
...
async def rancher_resource_quotas_list_tool(
    ...
    """List resource_quotas as lightweight typed summaries — identity, state, and a per-item health rollup rather than full specs — so an agent can enumerate what exists before opening any one in detail with the matching get tool. Omit `namespace` to list across the whole cluster; pass it to scope to one namespace."""
