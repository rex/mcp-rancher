...
# catalog/curated_tools/global_roles.yml. Do not edit by hand.
# Regenerate with: make codegen

"""Curated Rancher global_role tools."""
...
from rancher_mcp.tools.rbac.shared import (
    action_keys,
    build_global_role_query_params,
    data_items,
...
async def _fetch_global_roles_list(
    ...
    """Fetch and normalize the Rancher global_roles collection."""

    query_params = build_global_role_query_params(
        limit=limit,
        builtin=builtin,
        name=name,
...
async def rancher_global_roles_list(
    ...
    """List global_roles with typed summaries."""
...
async def _fetch_global_role_get(
    ...
    """Fetch and normalize one global_role."""
...
async def rancher_global_role_get(
    ...
    """Fetch one global_role by name."""

    resolved_settings = settings or get_settings()
    instance_name, instance_config = resolve_instance(resolved_settings, instance)
    if client is not None:
        return await _fetch_global_role_get(instance_name, global_role_id, client)
    async with RancherManagementClient(instance_name, instance_config) as managed_client:
        return await _fetch_global_role_get(
            instance_name,
            global_role_id,
            managed_client,
        )
