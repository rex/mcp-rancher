...
# catalog/curated_tools/_packs/rbac.yml plus all per-resource
...
from rancher_mcp.tools.rbac._generated_cluster_role_template_bindings import (
...
from rancher_mcp.tools.rbac._generated_global_role_bindings import (
...
from rancher_mcp.tools.rbac._generated_global_roles import (
    rancher_global_role_get,
    rancher_global_role_get_tool,
    rancher_global_roles_list,
    rancher_global_roles_list_tool,
)
from rancher_mcp.tools.rbac._generated_project_role_template_bindings import (
...
from rancher_mcp.tools.rbac._generated_role_templates import (
