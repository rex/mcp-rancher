...
def register_rbac_tools(mcp: FastMCP) -> None:
    ...
    mcp.tool(name="rancher_global_roles_list")(rancher_global_roles_list_tool)
    mcp.tool(name="rancher_global_role_get")(rancher_global_role_get_tool)
    mcp.tool(name="rancher_role_templates_list")(rancher_role_templates_list_tool)
    mcp.tool(name="rancher_role_template_get")(rancher_role_template_get_tool)
    mcp.tool(name="rancher_global_role_bindings_list")(rancher_global_role_bindings_list_tool)
    mcp.tool(name="rancher_global_role_binding_get")(rancher_global_role_binding_get_tool)
    mcp.tool(name="rancher_cluster_role_template_bindings_list")(
        rancher_cluster_role_template_bindings_list_tool
    )
    mcp.tool(name="rancher_cluster_role_template_binding_get")(
        rancher_cluster_role_template_binding_get_tool
    )
    mcp.tool(name="rancher_project_role_template_bindings_list")(
        rancher_project_role_template_bindings_list_tool
    )
    mcp.tool(name="rancher_project_role_template_binding_get")(
        rancher_project_role_template_binding_get_tool
    )
