...
async def rancher_prometheus_rules_list(
    ...
    """List prometheus_rules with typed summaries — in one namespace, or cluster-wide when namespace is omitted."""
...
async def _patch_prometheus_rule_set_labels(
    ...
    """Set_labels one prometheus_rule via JSON merge-patch; returns a mutation receipt."""
...
async def _patch_prometheus_rule_set_annotations(
    ...
    """Set_annotations one prometheus_rule via JSON merge-patch; returns a mutation receipt."""
...
async def rancher_prometheus_rules_list_tool(
    ...
    """List prometheus_rules as lightweight typed summaries — identity, state, and a per-item health rollup rather than full specs — so an agent can enumerate what exists before opening any one in detail with the matching get tool. Omit `namespace` to list across the whole cluster; pass it to scope to one namespace."""
