...
# catalog/curated_tools/_packs/alerts.yml plus all per-resource
...
from rancher_mcp.tools.alerts._generated_cluster_alert_rules import (
...
from rancher_mcp.tools.alerts._generated_notifiers import (
