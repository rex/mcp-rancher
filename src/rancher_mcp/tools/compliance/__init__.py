...
def register_compliance_tools(mcp: FastMCP) -> None:
    ...
    mcp.tool(name="rancher_cis_scan_profiles_list")(rancher_cis_scan_profiles_list_tool)
    mcp.tool(name="rancher_cis_scan_profile_get")(rancher_cis_scan_profile_get_tool)
    mcp.tool(name="rancher_cis_scans_list")(rancher_cis_scans_list_tool)
    mcp.tool(name="rancher_cis_scan_get")(rancher_cis_scan_get_tool)
