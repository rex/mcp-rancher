...
# catalog/curated_tools/projects.yml. Do not edit by hand.
...
async def rancher_projects_list(
    ...
    """List projects with typed summaries."""
...
async def rancher_project_get(
    ...
    async with RancherManagementClient(instance_name, instance_config) as managed_client:
        return await _fetch_project_get(
            instance_name,
            project_id,
            managed_client,
        )
