...
def register_fleet_registration_tools(mcp: FastMCP) -> None:
    ...
    mcp.tool(name="rancher_fleet_workspaces_list")(rancher_fleet_workspaces_list_tool)
    mcp.tool(name="rancher_fleet_workspace_get")(rancher_fleet_workspace_get_tool)
    mcp.tool(name="rancher_cluster_registration_tokens_list")(
        rancher_cluster_registration_tokens_list_tool
    )
    mcp.tool(name="rancher_cluster_registration_token_get")(
        rancher_cluster_registration_token_get_tool
    )
