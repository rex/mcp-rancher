...
# catalog/curated_tools/_packs/fleet_registration.yml plus all per-resource
...
from rancher_mcp.tools.fleet_registration._generated_cluster_registration_tokens import (
...
from rancher_mcp.tools.fleet_registration._generated_fleet_workspaces import (
