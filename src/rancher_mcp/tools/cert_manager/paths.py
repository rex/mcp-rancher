...
def _cert_manager_namespaced_collection_path(cluster_id: str, namespace: str, resource: str) -> str:
    """Build the namespaced collection path for a cert-manager.io/v1 resource."""
