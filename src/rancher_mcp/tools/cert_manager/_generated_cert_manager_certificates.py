...
async def rancher_cert_manager_certificates_list(
    ...
    """List cert_manager_certificates with typed summaries — in one namespace, or cluster-wide when namespace is omitted."""
