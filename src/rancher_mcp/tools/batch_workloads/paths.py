...
def _batch_v1_collection_path(cluster_id: str, namespace: str, resource: str) -> str:
    """Build the namespaced collection path for a batch/v1 resource."""

    return (
        f"/k8s/clusters/{quote(cluster_id, safe='')}/apis/batch/v1/"
