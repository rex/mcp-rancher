...
def register_app_catalog_tools(mcp: FastMCP) -> None:
    ...
    mcp.tool(name="rancher_catalogs_list")(rancher_catalogs_list_tool)
    mcp.tool(name="rancher_catalog_get")(rancher_catalog_get_tool)
    mcp.tool(name="rancher_templates_list")(rancher_templates_list_tool)
    mcp.tool(name="rancher_template_get")(rancher_template_get_tool)
    mcp.tool(name="rancher_template_versions_list")(rancher_template_versions_list_tool)
    mcp.tool(name="rancher_template_version_get")(rancher_template_version_get_tool)
